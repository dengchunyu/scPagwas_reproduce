...
for method in methods:
    for gwas in gwass:
        ...
        df_re.to_csv("/share/pub/dengcy/GWAS_Multiomics/MultiMethods/" + method + "/scDRS_result/pbmcmodel/"+ gwas + "_scDRSresult.csv", sep=",")
...
df_re=pd.concat(objs=df_scores,axis=1,ignore_index=True)
df_re.columns=names
df_re.to_csv("/share/pub/dengcy/GWAS_Multiomics/realgroundtruth/ThreeMethods_scDRSresult_pbmcmodel.csv", sep=",")
...
df_re=pd.concat(objs=df_scores,axis=1,ignore_index=True)
df_re.columns=names
df_re.to_csv("/share/pub/dengcy/GWAS_Multiomics/realgroundtruth/MAGMA_scDRSresult_pbmcmodel.csv", sep=",")
...
df_re=pd.concat(objs=df_scores,axis=1,ignore_index=True)
df_re.columns=names
df_re.to_csv("/share/pub/dengcy/GWAS_Multiomics/realgroundtruth/MAGMA_scDRSresult_pbmcmodel_Lymphocytecount3.csv", sep=",")